...
export const FeeSchedulePage: React.FC<FeeSchedulePageProps> = ({ userRole }) => {
  ...
  useEffect(() => {
    const fetchInit = async () => {
      ...
      try {
        ...
        console.error("Erreur d'initialisation FeeSchedulePage:", err);
  ...
  const loadScheduleData = useCallback(async () => {
    ...
    try {
      ...
      console.debug(`[FeeSchedulePage] Paiements trouvés pour classId=${selectedClassId} / yearId=${selectedSchoolYearId}: ${pCount}`);
      ...
      console.error("Erreur lors du chargement du tarif de classe:", err);
    ...
    <div className="p-4 md:p-6 space-y-6 max-w-5xl mx-auto">
      ...
      <div className="bg-white p-4 border border-line rounded shadow-sm flex flex-col sm:flex-row sm:items-end gap-4">
        ...
        <div className="flex-1 min-w-[180px]">
          <label htmlFor="select-class-fee" className="block text-xs font-semibold text-slate uppercase mb-1">
            Classe
          </label>
          <select
            id="select-class-fee"
        ...
        <div className="min-w-[180px]">
          <label htmlFor="select-year-fee" className="block text-xs font-semibold text-slate uppercase mb-1">
            Année Scolaire
          </label>
          <select
            id="select-year-fee"
