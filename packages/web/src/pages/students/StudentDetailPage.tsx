    ...
    try {
      ...
      try {
        ...
        if (activeYear?.id) {
          ...
          // Fallback sur la première année scolaire disponible
              ...
              {feeOverride ? (
                <div className="w-full p-2.5 bg-emerald-50/80 border border-emerald-200 rounded text-xs space-y-1">
                  ...
                  <button
                    ...
                    className="mt-2 w-full py-1.5 px-3 bg-white hover:bg-emerald-100 text-emerald-900 rounded text-xs font-semibold border border-emerald-300 transition flex items-center justify-center gap-1 cursor-pointer shadow-2xs"
                  >
